...
public class LocaleUtils {
     ...
     * @return true if locale code is legal or false
     */
    public static boolean isLegal(String code){
        return null != getInstance(code);
    }

    /**
     * get instance according to locale code
     * @param code the locale code
     * @return instance of {@link Locale}
     */
    public static Locale getInstance(String code){
        for(Locale locale : Locale.getAvailableLocales()){
            if(locale.toString().equalsIgnoreCase(code))
                return locale;
        }
        return null;
    }
